...
async def run_diagnostics():
    ...
    # 1. Latência
    from scripts.diagnostics.test_latency import LatencyTester
    lt = LatencyTester()
    ...
    # 2. Modelo ML
    from scripts.diagnostics.test_ml_model import MLModelTester
    mt = MLModelTester()
    print("\n[2/3] Validando Modelo ML...")
    ml_ok = mt.test_model_integrity()
    
    # 3. Decision System
    from scripts.diagnostics.test_decision_system import DecisionSystemTester
