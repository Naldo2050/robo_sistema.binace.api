...
from market_analysis.regime_detector import RegimeAnalysis
...
def example_usage():
    ...
    from market_analysis.regime_detector import MarketRegime, CorrelationRegime, VolatilityRegime, RegimeAnalysis
